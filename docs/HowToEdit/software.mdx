...
| `size`     | Icon size in pixels, defaults to matching the surrounding text size.                             |
...
Contact us on our <Social name="discord" label="Discord server" link="https://discord.com/invite/6RwR6SYBW6"/>
