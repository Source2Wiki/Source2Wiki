...
The behavior of the **Lightness** slider is closer to an HSL-style model (Hue/Saturation/Lightness) than HSV.

:::todo
Confirm the exact internal math against the shader source.
:::
