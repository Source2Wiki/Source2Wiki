...
### End State
If a state is marked as an End State, and its child is "finished", then the state machine will tell its parent that it also is "finished".  State machines can have zero or more End States.
