...
- Rotation random
    ...
    Randomizes the initial rotation of the particle between yaw offset min and yaw offset max plus yaw initial on top of that. Roll is the most relevant field for basic sprites. 
