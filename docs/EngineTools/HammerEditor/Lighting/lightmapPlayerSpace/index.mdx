...
:::info
You can view the lightmap resolution by clicking the `Show Lightmap Res/Luxels` button in the convar helper section of the console, or by setting <Convar name="mat_luxels"/> to `1` 
:::
