---
title: Testing Setup
description: A script which sets up a testing environment with infinite round time, and showcases the OnBeforePlayerDamage event.
---

A script which sets up a testing environment with infinite round time, and showcases the OnBeforePlayerDamage event.

found at `Counter-Strike Global Offensive\content\csgo_addons\cs_script_demo\maps\scripts\setup.js`
