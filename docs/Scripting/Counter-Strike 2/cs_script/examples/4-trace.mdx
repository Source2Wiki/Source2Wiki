---
title: Traces
description: A script showcasing tracing lines, spheres, boxes and bullets.
---

A script showcasing tracing lines, spheres, boxes and bullets.

found at `Counter-Strike Global Offensive\content\csgo_addons\cs_script_demo\maps\scripts\trace.js`
