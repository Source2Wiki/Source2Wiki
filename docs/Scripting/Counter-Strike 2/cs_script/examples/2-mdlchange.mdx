---
title: Model Change
description: A showcase of setting models on entities, and changing size and glow.
---

A showcase of setting models on entities, and changing size and glow.

found at `Counter-Strike Global Offensive\content\csgo_addons\cs_script_demo\maps\scripts\mdlchange.js`
