---
title: Input
description: A script showcasing player input listening and registering a custom console command.
---

A script showcasing player input listening and registering a custom console command.

found at `Counter-Strike Global Offensive\content\csgo_addons\cs_script_demo\maps\scripts\input.js`
