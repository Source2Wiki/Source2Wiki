...
description: A training course for throwing grenades.
---

A training course for throwing grenades.

found at `Counter-Strike Global Offensive\content\csgo_addons\cs_script_demo\maps\scripts\grenadetraining.js`
