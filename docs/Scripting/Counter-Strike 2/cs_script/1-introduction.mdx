...
A significant amount of documentation on this page is taken from `Counter-Strike Global Offensive\content\csgo\maps\editor\zoo\scripts\point_script.d.ts`
:::

`Counter-Strike Global Offensive\content\csgo\maps\editor\zoo\scripts\point_script.d.ts` documents the JavaScript API for cs_script scripts attached to point_script entities.
