...
:::info
<Tool name="github" suffix="Datamodel.NET" link="https://github.com/ValveResourceFormat/Datamodel.NET"/> is an open source C# library that reads and writes every 
...
- <Tool name="github" suffix="Datamodel.NET" link="https://github.com/ValveResourceFormat/Datamodel.NET"/> (C#) - reads/writes `binary` 1-5 and 9, `keyvalues2` 1-4, typed element classes for the `vmap` format.
- <Tool name="github" suffix="datamodel.py" link="https://github.com/Artfunkel/BlenderSourceTools/blob/master/io_scene_valvesource/datamodel.py"/> (Python) - the reader/writer inside Blender Source Tools, used for Source 1 and Source 2 `.dmx` model exports.
- <Tool name="github" suffix="datamodel-rs" link="https://github.com/Jakobg1215/datamodel-rs"/> (Rust) - DMX reader/writer.
- <Tool name="github" suffix="sourcepp" link="https://github.com/craftablescience/sourcepp"/> (C++, with Python bindings) - a collection of Source format parsers that includes DMX.
