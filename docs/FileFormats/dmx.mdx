...
A `string` below is a null terminated UTF-8 string, a `string ref` is an index into the string table (`int16` or `int32` depending on the version, see [versions](#versions)).
