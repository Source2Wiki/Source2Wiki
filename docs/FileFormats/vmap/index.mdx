...
It is a [DMX](../dmx.mdx) file under binary encoding version 9, [Hammer](../../EngineTools/HammerEditor/index.mdx) can export a plain text version if you go to `File -> Save Copy As Text`
...
This is not a real vmap node, but [CMapMesh](#cmapmesh), [CMapWorld](#cmapworld) and [CMapInstance](#cmapinstance) share these properties so this seems like a likely base class.
