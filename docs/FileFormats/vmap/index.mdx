...
<Tool name="github" suffix="Datamodel.NET" link="https://github.com/ValveResourceFormat/Datamodel.NET"/> can be used to read and write kv2 files including vmaps, using C#.
