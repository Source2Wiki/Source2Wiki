...
:::info
I recommend downloading the example addon to follow along.
...
A complete description and walkthrough of the file format can be found on the [CS2 detail props vdata page](/FileFormats/cs2_detail_props).
...
Now you understand editing `detail_prop_types.vdata`. If you would prefer a 3rd party tool, one has been created by `dertwist`. 
