...
`encoding.txt` is a file that controls sound compile parameters, like compression, loop points, sample rate, normalization, etc. 
...
#### crossfade_ms
Set crossfade between loop transition in milliseconds.
