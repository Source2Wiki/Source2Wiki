...
This guide explains how to export blender geometry to Source 2 in 1:1 scale.  

---

:::info
We will use `.fbx` files for the tutorial. It is highly recommended to avoid `.obj` files, because there are many missing features or lack of standardization. For more information see the dropdown table.
...
It is highly recommended to set your scene units to `None`. When exporting meshes to advanced formats such as `.fbx`, `.glb`, or `.gltf`, these file types often include metadata containing the scene’s unit scale. Different software handle this differently. Maya
...
Now your mesh will be ready to use in the Source 2 workflow. You can import your mesh into Modeldoc or Hammer.  
