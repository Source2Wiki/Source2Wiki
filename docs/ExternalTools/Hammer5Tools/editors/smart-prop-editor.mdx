...
For the SmartProp concepts behind these controls, see the [SmartProps guide](../../../EngineTools/HammerEditor/SmartProps/index.mdx). The [Modular pipes with FitOnLine](../../../EngineTools/HammerEditor/SmartProps/FitOnLine/index.mdx) guide works through a complete procedural asset.
