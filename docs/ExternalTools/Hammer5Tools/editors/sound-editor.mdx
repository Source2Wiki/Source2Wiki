...
With <Game name="cs2"/> running and reachable over the console command pipe, the editor can send <Convar name="snd_sos_stop_all_soundevents"/> followed by <Convar name="snd_sos_start_soundevent"/> `<name>` to preview the selected event.
