...
Markers are stored in the saved WAV file as RIFF cue points. <Game name="cs2"/> reads the first two as the loop region — see the [CS2 Looping music](../../../CommunityGuides/loopingRadio/index.mdx) guide.
